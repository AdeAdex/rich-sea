...
//           />
//           {/* Sign-in Button */}
//           <button className="w-full bg-rich-sea-sky text-white py-2 rounded-lg mb-4 hover:bg-rich-sea-sky-hover font-bold font-raleway text-lg">
//             Sign In
//           </button>

//           {/* Forgot Password */}
//           <div className="flex justify-between mb-6">
//             <span className="text-red-500 text-sm mb-4 italic font-bold">
