  ...
  return (
    <div className="border rounded-lg shadow-md p-4 flex flex-col items-center bg-white font-raleway">
      ...
      <div className="flex flex-col items-center gap-2 mt-[-20px]">
        ...
        <span className="text-[13px] text-gray-500 font-[800] ">
          {subtitle}
        </span>
      </div>
      ...
      {/* Title and Details */}
      <div className="px-3">
        <h3 className="text-lg font-[800] mt-2 text-center">{title}</h3>
        <p className="text-sm text-gray-500 mt-1 font-[600] font-inter flex justify-between w-full">
          Reward zone: <span className="font-[500]">{reward}</span>
        </p>
        <p className="text-sm text-gray-500 font-[600] font-inter flex justify-between w-full">
      ...
      {/* Action Button */}
      <button
        className={`mt-4 px-4 py-1 rounded-lg font-[700] font-raleway text-[17px] ${
          status === "Joined"
